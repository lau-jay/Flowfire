...
from flowfire.backends.backend import BackendBookCallback, BackendCallback
...
class GCPPubSubCallback:
    def __init__(
        ...
        topic: str
            Topic name. Defaults to 'flowfire-{key}', for example 'flowfire-trades'
        key: str
        ...
        self.topic = topic or f"flowfire-{self.key}"
