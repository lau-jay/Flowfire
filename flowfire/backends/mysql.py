...
from flowfire.backends.backend import (
    BackendBookCallback,
    BackendCallback,
    BackendQueue,
)
...
class MySQLCallback(BackendQueue):
    def __init__(
        ...
        **kwargs,
        ...
        custom_columns: dict
            A dictionary which maps flowfire's data type fields to MySQL's table column names, e.g. {'symbol': 'instrument', 'price': 'price', 'amount': 'size'}
