...
import asyncio
from flowfire.connection import Connection
import logging
import signal
...
from flowfire.config import Config
from flowfire.defines import L2_BOOK
from flowfire.feed import Feed
from flowfire.log import get_logger
from flowfire.nbbo import NBBO
...
class FeedHandler:
    ...
    def run(
        ...
        install_signal_handlers: bool, default True
            ...
            can only be done from the main thread's loop, so if running flowfire on
