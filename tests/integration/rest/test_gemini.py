...
from flowfire.defines import BID, ASK, LIMIT, BUY, CANCELLED
from flowfire.exchanges import Gemini
...
class TestGeminiRest:
    ...
    @pytest.mark.skipif(
        not sandbox.key_id or not sandbox.key_secret, reason="No api key provided"
    )
