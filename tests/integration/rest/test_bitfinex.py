...
from flowfire.defines import ASK, BID, BUY, SELL, BITFINEX
from flowfire.exchanges import Bitfinex
...
class TestBitfinexRest:
    def test_trade(self):
        ...
        for data in b.trades_sync(
            "BTC-USD", start="2017-01-01 00:00:00", end="2017-01-01 0:00:13"
        ):
            ret.extend(data)
    ...
    def test_trades(self):
        ret = []
        for data in b.trades_sync(
            "BTC-USD", start="2019-01-01 00:00:00", end="2019-01-01 8:00:13"
        ):
            ret.extend(data)
        ...
        assert ret[0] == {
            ...
            "feed": "BITFINEX",
            "side": BUY,
            "amount": Decimal("0.27273351"),
            "price": Decimal("3834.7"),
            "id": 329252035,
        ...
        assert ret[-1] == {
            ...
            "feed": "BITFINEX",
            "side": BUY,
            "amount": Decimal("0.01631427"),
            "id": 329299342,
            "price": Decimal(3850),
            "timestamp": 1546329604.0,
        }
