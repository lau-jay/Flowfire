...
from flowfire.callback import TradeCallback
...
async def trade(
    ...
    print(
        "Timestamp: {} Feed: {} Pair: {} ID: {} Side: {} Amount: {} Price: {}".format(
            timestamp, feed, symbol, order_id, side, amount, price
        )
    )
...
def main():
    ...
    f.add_feed(
        Coinbase(
            ...
            callbacks={TRADES: [TradeCallback(trade), TradeCallback(trade2)]},
        )
    )
