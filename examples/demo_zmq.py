...
from flowfire.backends.zmq import BookZMQ, TickerZMQ
from flowfire.defines import L2_BOOK, TICKER
from flowfire.exchanges import Coinbase, Kraken
    ...
    try:
        ...
        f.add_feed(
            Kraken(
                ...
                callbacks={
                    L2_BOOK: BookZMQ(
                        snapshots_only=False, snapshot_interval=2, port=5678
                    )
                },
            )
        )
