...
from flowfire.backends.kafka import BookKafka, TradeKafka
from flowfire.defines import L2_BOOK, TRADES
...
def main():
    ...
    f.add_feed(
        Coinbase(
            max_depth=10, channels=[TRADES, L2_BOOK], symbols=["BTC-USD"], callbacks=cbs
        )
    )
