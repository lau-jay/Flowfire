...
[![PyPi](https://img.shields.io/badge/PyPi-flowfire-brightgreen.svg)](https://pypi.python.org/pypi/flowfire)
[![Codacy Badge](https://api.codacy.com/project/badge/Grade/efa4e0d6e10b41d0b51454d08f7b33b1)](https://www.codacy.com/app/bmoscon/flowfire?utm_source=github.com&amp;utm_medium=referral&amp;utm_content=bmoscon/flowfire&amp;utm_campaign=Badge_Grade)
...
flowfire also provides a synthetic [NBBO](examples/demo_nbbo.py) (National Best Bid/Offer) feed that aggregates the best bids and asks from the user specified feeds.

```python
from flowfire import FeedHandler
from flowfire.exchanges import Coinbase, Gemini, Kraken
...
flowfire supports the following channels from exchanges:
...
**Note:** flowfire requires Python 3.8+
